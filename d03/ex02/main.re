let main = () => {
  ...
  print_endline(
    Uncipher.unrot42("Wqkjyuh Lqdduiju 33 Cqhyu-Fyuhhu Rhysqwu 28"),
  );
  print_string("\n\n");
  print_endline("*******************************");
  ...
  print_endline(
    Cipher.caesar(19, "Gautier Vanneste 33 Marie-Pierre Bricage 28 !?:)"),
  );
  print_char('\n');
  ...
  print_endline(
    Uncipher.uncaesar("Ztnmbxk Otggxlmx 33 Ftkbx-Ibxkkx Ukbvtzx 28 !?:)", 19),
  );
  print_string("\n\n");
  print_endline("*******************************");
  print_endline("---- xor ----");
  ...
  print_endline(
    Cipher.xor(19, "Gautier Vanneste 33 Marie-Pierre Bricage 28 !?:)"),
  );
  print_char('\n');
  ...
  print_endline(
    Cipher.ft_crypt(
      "abcdefgh01234",
      [Cipher.caesar(14), Cipher.xor(13), Cipher.rot42],
    ),
  );
  print_endline(
    Cipher.ft_crypt("", [Cipher.caesar(14), Cipher.xor(13), Cipher.rot42]),
  );
  print_endline(
    Cipher.ft_crypt(
      "> % GHTU78jkldn",
      [Cipher.xor(67), Cipher.rot42, Cipher.caesar(21)],
    ),
  );
  print_endline(
    Cipher.ft_crypt(
      "Gautier Vanneste 33 Marie-Pierre Bricage 28 !?:)",
      [Cipher.rot42, Cipher.caesar(32), Cipher.xor(18)],
    ),
  );
  print_char('\n');
  ...
  print_endline(
    Uncipher.ft_uncrypt(
      ...
      [Uncipher.unrot42, Cipher.xor(13), Uncipher.uncaesar(~arg1=14)],
    ),
  );
  print_endline(
    Uncipher.ft_uncrypt(
  ...
  print_endline(
    Uncipher.ft_uncrypt(
      ...
      [Uncipher.uncaesar(~arg1=21), Uncipher.unrot42, Cipher.xor(67)],
    ),
  );
  print_endline(
    Uncipher.ft_uncrypt(
      ...
      [Cipher.xor(18), Uncipher.uncaesar(~arg1=32), Uncipher.unrot42],
    ),
  );
  print_char('\n');
};
